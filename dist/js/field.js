...
Nova.booting(function (Vue, router) {
    Vue.component('index-multilingual-nova', __webpack_require__(5));
    Vue.component('detail-multilingual-nova', __webpack_require__(11));
    Vue.component('form-multilingual-nova', __webpack_require__(16));
...
var update = __webpack_require__(2)("c54d1132", content, false, {});
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        getLangUrl: function getLangUrl(locale) {
            console.log(this.field);
            return Nova.config.base + "/resources/" + this.resourceName + "/" + this.field.value.id + "/edit" + "?lang=" + locale.value;
        }
    }
});
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    methods: {
        getLangUrl: function getLangUrl(locale) {
            return this.field.value.id + "?lang=" + locale.value;
        }
    }
});
